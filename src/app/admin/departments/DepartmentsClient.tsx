...
import {
  ...
  CheckSquare, Square, Clock, Download
} from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/50 dark:bg-[#0B0F17]/80 flex items-end sm:items-center justify-center p-0 sm:p-4 z-50 animate-in fade-in duration-200 backdrop-blur-sm">
          <div className="bg-white dark:bg-[#111827] rounded-t-3xl sm:rounded-2xl w-full max-w-xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden animate-in slide-in-from-bottom-full sm:zoom-in-95 duration-300 flex flex-col max-h-[90vh]">
